...
5. For C/D changes, complete required soak coverage including upstream/DNS/network failure and restart recovery.
...
Report upstream, old/new version and digest, release/security/license analysis, generated changes, tests, soak, compatibility, rollback, and PR. Missing authoritative metadata or verification prevents `VERIFIED`.
